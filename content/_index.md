...
Synergy VR is still in development, and so are these docs. Nothing here is final. For news, watch the {{< discord "WjSUaSPaQZ" >}}Synergy Discord{{< /discord >}}.
{{< /aside >}}

These pages will cover what you need to install the list, set it up, and understand what it changes about Skyrim VR.

## Standout Features & Highlights

### A Hyper-Tactile World & Advanced Physics

- Physical Climbing: Native VR Climbing allows you to physically scale mountain faces, city walls, and structural ruins by grabbing the environment.
- True Ragdoll Physics: Fully integrated real-time ragdoll physics apply dynamically to all NPCs, animals, and massive dragons for immersive world interactions.
- Reactive Geometry: The environment responds to your hands and weapons with physics-based doors and swinging chains.
- Visceral Combat: Features dynamic melee collisions, pseudo-weapon parrying, real-time object throwing, and an integrated Dismembering Framework with dedicated asset packs.
- Secondary Physics: Full HDT-SMP and CBPC frameworks ensure fluid hair, clothing, and armor movement.
